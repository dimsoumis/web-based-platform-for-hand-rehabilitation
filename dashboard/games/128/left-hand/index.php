...
var countdown = setInterval(function() {
  ...
  if (seconds >= 600) {
	  ...
	  localStorage.setItem("ekatoneikosioktoLeftTime", seconds);
	  localStorage.setItem("ekatoneikosioktoLeftScore", currentNumber);
	    exerStarted = 0;
...
/*dim custom code 2 start*/
 ...
 if (difAntiheirasDiktis < 0.05 && difAntiheirasMesos < 0.05 && thesiAntiheiraX > xTetr1 && thesiAntiheiraX < xTetr1 + 200
	 ...
	 if (thesiAntiheiraX < 300 || thesiAntiheiraY > 780) {
