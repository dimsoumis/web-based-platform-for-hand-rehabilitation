...
<title>Write the Letter - Level 1</title>
...
ctx.beginPath();	
ctx.rect(860, 240, 200, rectHeight);
ctx.lineWidth = 10;
ctx.fillStyle = "#333";
ctx.globalAlpha = 0.5;
ctx.fill();
...
var countdown = setInterval(function() {
  ...
  if (seconds >= 600) {
	  ...
	  localStorage.setItem("writeTheLetterLevel1RightScore", seconds);
	    exerStarted = 0;
...
/*dim custom code 2 start*/
  ...
  var difAntiheirasDiktis = Math.sqrt(difxAntiheirasDiktis * difxAntiheirasDiktis + difyAntiheirasDiktis * difyAntiheirasDiktis);
   var difAntiheirasMesos = Math.sqrt(difxAntiheirasMesos * difxAntiheirasMesos + difyAntiheirasMesos * difyAntiheirasMesos);
		...
		if (difAntiheirasDiktis < 0.05 && difAntiheirasMesos < 0.05 && thesiAntiheiraX > 860 && thesiAntiheiraX < 1060
		   && thesiAntiheiraY > 240 && thesiAntiheiraY < 840 && grabbing == false && getFromTop == true) {

				 drawConnectors(canvasCtx, landmarks, HAND_CONNECTIONS, {color: '#00ff00', lineWidth: 1});
			 drawLandmarks(canvasCtx, landmarks, {color: '#00ff00', lineWidth: 1});
			
        rectHeight = thesiAntiheiraY - 240;
