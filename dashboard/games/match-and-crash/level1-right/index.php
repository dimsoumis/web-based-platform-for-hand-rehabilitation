...
<title>Match & Crash - Level 1</title>
...
var circGoalAch = 0; 
	...
	function drawShapes(xT, yT, xK, yK) {
		ctx.beginPath();	
ctx.rect(xT, yT, 200, 200);
ctx.lineWidth = 10;
ctx.fillStyle = "#0f0";
ctx.globalAlpha = 0.5;
ctx.fill();
...
ctx.fill();		
   ...
   drawShapes(xTetr, yTetr, xKikl, yKikl);
...
var countdown = setInterval(function() {
  ...
  if (seconds >= 600) {
	  ...
	  localStorage.setItem("matchCrashLevel1RightScore", seconds);
	    exerStarted = 0;
...
/*dim custom code 2 start*/
  ...
  var difAntiheirasDiktis = Math.sqrt(difxAntiheirasDiktis * difxAntiheirasDiktis + difyAntiheirasDiktis * difyAntiheirasDiktis);
   var difAntiheirasMesos = Math.sqrt(difxAntiheirasMesos * difxAntiheirasMesos + difyAntiheirasMesos * difyAntiheirasMesos);
		...
		if (difAntiheirasDiktis < 0.05 && difAntiheirasMesos < 0.05 && thesiAntiheiraX > xTetr && thesiAntiheiraX < xTetr + 200
		   && thesiAntiheiraY > yTetr && thesiAntiheiraY < yTetr + 200 && grabbing == false && thesiAntiheiraX < 1220 && thesiAntiheiraX > 700 && thesiAntiheiraY > 180 && thesiAntiheiraY < 420 && grabbingKiklo == false) {
   ...
   drawShapes(xTetr, yTetr, xKikl, yKikl);
		} else if (difAntiheirasDiktis < 0.05 && difAntiheirasMesos < 0.05 && thesiAntiheiraX > xKikl - 100 && thesiAntiheiraX < xKikl + 100 && thesiAntiheiraY > yKikl - 100 && thesiAntiheiraY < yKikl + 100 && grabbing == false && thesiAntiheiraX < 1220 && thesiAntiheiraX > 700 && thesiAntiheiraY > 180 && thesiAntiheiraY < 420) {
   ...
   drawShapes(xTetr, yTetr, xKikl, yKikl);
		...
		if (rectGoalAch > 0 && circGoalAch > 0) {
