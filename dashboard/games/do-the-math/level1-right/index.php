...
<title>Do the Math - Level 1</title>
...
var rect1GoalAch = 0;
	...
	function drawShapes(xT1, yT1, cT1) {
...
ctx.globalAlpha = 1;
ctx.font = "100px Arial";
ctx.fillText("11", 1460 + 50, 460 + 130);
		ctx.closePath();
...
ctx.fillText("=", 1160 + 50, 460 + 130);
   ...
   drawShapes(xTetr1, yTetr1, rect1GoalColor);
...
var countdown = setInterval(function() {
  ...
  if (seconds >= 600) {
	  ...
	  localStorage.setItem("doTheMathLevel1RightScore", seconds);
	    exerStarted = 0;
...
/*dim custom code 2 start*/
 ...
 if (difAntiheirasDiktis < 0.05 && difAntiheirasMesos < 0.05 && thesiAntiheiraX > xTetr1 && thesiAntiheiraX < xTetr1 + 200
		   && thesiAntiheiraY > yTetr1 && thesiAntiheiraY < yTetr1 + 200 && grabbing == false && rect1GoalAch != 1) {
	...
	if (xTetr1 > 820 && xTetr1 < 900 && yTetr1 > 420 & yTetr1 < 500) {
			rect1GoalColor = "#0f0";
			if (hasLetGo == true) {
		   rect1GoalAch = 1;
			}
