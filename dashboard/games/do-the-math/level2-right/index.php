...
<title>Do the Math - Level 2</title>
...
ctx.fillText("4", xT1 + 75, yT1 + 130);
		ctx.closePath();
		
			// square 2
		
	ctx.beginPath();	
ctx.rect(860, 460, 200, 200);
ctx.lineWidth = 10;
ctx.fillStyle = "#0f0";
ctx.globalAlpha = 0.5;
ctx.fill();
...
ctx.globalAlpha = 1;
ctx.font = "100px Arial";
ctx.fillText("12", xT2 + 40, yT2 + 130);
		ctx.closePath();
...
var countdown = setInterval(function() {
  ...
  if (seconds >= 600) {
	  ...
	  localStorage.setItem("doTheMathLevel2RightScore", seconds);
	    exerStarted = 0;
 ...
 if (difAntiheirasDiktis < 0.05 && difAntiheirasMesos < 0.05 && thesiAntiheiraX > xTetr1 && thesiAntiheiraX < xTetr1 + 200
	...
	if (xTetr1 > 220 && xTetr1 < 300 && yTetr1 > 420 & yTetr1 < 500) {
		   ...
		   rect1GoalAch = 0;
					...
					if (xTetr2 > 1420 && xTetr2 < 1500 && yTetr2 > 420 & yTetr2 < 500) {
			rect2GoalColor = "#0f0";
			if (hasLetGo == true) {
		   rect2GoalAch = 1;
			}
